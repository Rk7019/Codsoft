...
label_entry = tk.Label(input_frame, text="New Task:")
...
button_add_task = tk.Button(input_frame, text="Add Task", command=add_task_gui)
...
listbox_tasks = tk.Listbox(list_frame, height=10, width=50, selectmode=tk.SINGLE)
...
button_delete_task = tk.Button(root, text="Delete Selected Task", command=delete_task_gui, width=20)
